...
//    {
//        private readonly IEventStoreClientWrapper _connectionWrapper;
//        private readonly string _streamBaseName;
//        private readonly IEventSerializer _eventDeserializer;

//        public EventStoreAggregateRepository(IEventStoreClientWrapper connectionWrapper, IEventSerializer eventDeserializer)
//        {
...
//            var eventPayload = new EventData(EventStore.Client.Uuid.NewUuid(), eventType.Name, true, data, metadata);
//            return eventPayload;
//        }
